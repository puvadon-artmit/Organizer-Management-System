...
<form action="../../Router/User/Pay_eventDB.php?orderID=<?php echo $orderID; ?>" id="form1" method="POST" enctype="multipart/form-data">  
...
foreach ($payments as $payment) {
    if ($payment['pay_type'] === 'ค่าจัดงานอีเว้นท์') {
        ...
        <div class="flex justify-center">
            <button data-popover-target="popover-offset" data-popover-offset="30" type="button" class="justify-center text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">ดูสลิป</button>
