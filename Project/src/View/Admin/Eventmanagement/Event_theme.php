            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    <div
                        ...
                        <form name="form1" method="post" action="../../../Router/Admin/Add_event_db.php"
                            enctype="multipart/form-data">
                            <div class="mb-6">
                                <label for="base-input"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อธีมงานอีเว้นท์</label>
                                <input type="text" name="event_name"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    autofocus autocomplete required>
                            </div>
                            <label for="" class="text-sm mb">ประเภทงานอีเว้นท์</label>
                            <select id="countries" class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="type_id" required>
                                <?php
                        ...
                        ?>
                            ...
                            <input
                                ...
                                name="image" type="file" autofocus autocomplete required>
