                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <a href="./Editevent.php?id=<?php echo $row['event_id']; ?>"
                                    class="text-white bg-yellow-300 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900">แก้ไขอีเว้นท์</a>
                            </td>
                            <td class="px-6 py-4">
                                <a href="./Viewdetails.php?id=<?php echo $row['event_id']; ?>"
                                    class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">รายละเอียด</a>
