...
<body>
   ...
   ?>
    ...
    <path d="m3.84 13.522 8.73 1.825.369-1.755-8.73-1.825-.369 1.755ZM4.995 9.2l8.083 3.763.739-1.617L5.734 7.56 4.995 9.2Zm3.372-5.482L7.235 5.08l6.859 5.704 1.132-1.362-6.859-5.704ZM12.57 16H3.655v2h8.915v-2ZM9.861 2.111l6.193 6.415 1.414-1.415-6.43-6.177-1.177 1.177Z"/>
                            ...
                            <a href="../Member/Event_status.php">
                                <li>
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                $sql = "SELECT o.organizer_id, o.firstname, o.lastname, o.oz_email, o.profile_ogz, o.uroles, o.created_at, t.type_organizer, e.event_date, e.job_dt, e.job_price, e.orderID, e.job_status
                                FROM organizer AS o 
                                INNER JOIN type_organizer AS t ON o.type_ogzid = t.type_ogzid 
                                LEFT JOIN employment AS e ON o.organizer_id = e.organizer_id
                                WHERE o.uroles = 'organizer' AND o.organizer_id = :organizer_id
    ...
    if ($job_status === 'pending') {
        ...
        echo '<span class="text-red-500">cancel</span>';
    } elseif ($job_status === 'accord') {
        echo '<span class="text-green-500">accord</span>';
    } else {
        echo $job_status; // ในกรณีอื่น ๆ
    }
    ?>
</td>
