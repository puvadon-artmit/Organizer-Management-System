...
?>
            <?php foreach ($eventOrders as $eventOrder) : ?>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 ">
                        <a href="./Venue_event.php?orderID=<?php echo $eventOrder['orderID']; ?>" class="font-medium text-yellow-400 dark:text-blue-500 hover:underline">ดูสถานที่จัดงานอีเว้นท์</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
