   ...
   ?>
    ...
    <section id="content">
        ...
        <main>
          ...
          <p class="text-4xl font-black text-gray-900 dark:text-white">รายการรับงานอีเว้นท์</p>
           <!-- ----------------- -->
             <!-- ข้อมูลเทเบิ้ล -->
...
<?php } ?>
    ...
    <?php if ($eventOrder['order_status'] == 3) : ?>
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4 text-right">
                <form action="../../../Router/Admin/Successful_event.php?orderID=<?php echo $eventOrder['orderID']; ?>"
                    id="form1" method="POST" enctype="multipart/form-data">
                    <button type="submit"
                        class="text-white bg-green-500 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">สำเร็จ</button>
                </form>
            </td>
        </tr>
    <?php endif; ?>
