...
<body>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            ...
            <p class="text-4xl font-black text-gray-900 dark:text-white">ยกเลิกงานอีเว้นท์แล้ว</p>
            <?php
             $organizer_id = $_SESSION['user_id'];
             $sql = "SELECT event_date, job_dt, job_price, organizer_id, orderID, job_status, epm_id FROM employment WHERE organizer_id = :organizer_id AND job_status = 'cancel' ORDER BY event_date DESC LIMIT 3";
