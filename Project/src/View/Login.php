  ...
  <section class="flex flex-col md:flex-row h-screen items-center">
    ...
    <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto  md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
      ...
      <div class="w-full h-100">
        <h1 class="text-xl font-bold">BTALL ORGANIZER</h1>
        <h1 class="text-xl md:text-2xl font-bold leading-tight mt-12">Log in to your account</h1>
        <form class="mt-6" action="../Component/Members/Login_db.php" method="post">
...
<?php } ?>
          ...
          <div class="text-right mt-2">
            <a href="#" class="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700"></a>
          </div>
          <button type="submit" name="signin" class="w-full block bg-blue-500 hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold rounded-lg
        ...
        <p class="text-sm text-gray-500 mt-12"></p>
      </div>
    </div>
  </section>
</body>
